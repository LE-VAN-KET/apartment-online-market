...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:9090/api/order/return";
    public static String vnp_TmnCode = "I1CMI7QP";
    public static String vnp_HashSecret = "BBITXQERANGFWFUNSTQZSFDTLVJZZUSE";
